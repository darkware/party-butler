...
public class CrystalCaseFactory {
    ...
    private void loadPictures() {
        try {
            cdCase = ImageIO.read(new File("ui-resources/cd_case.png"));
            stitch = ImageIO.read(new File("ui-resources/stitch.png"));
            reflections = ImageIO.read(new File("ui-resources/reflections.png"));
